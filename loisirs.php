...
<div class="loisirs">
    <figure>
        <figcaption>
            <img src="./asset/plage.jpg" alt="Natation">
            <h2>La Natation</h2>
    ...
    <figure>
        <figcaption>
            <img src="./asset/poesie.jpg" alt="Poesie">
            <h2>La poésie</h2>
    ...
    <figure>
        <figcaption>
            <img src="./asset/musique.png" alt="Musique">
            <h2>La Musique</h2>
            <p>Nos schtroumpf émotions, reveille notre schtroumpf humeur, développe nos schtroumpf compétences, renforce les liens sociaux et peut même provoquer des schtroumpf explosion !</p>
        </figcaption>
    </figure>
    <figure>
        <figcaption>
            <img src="./asset/cooking.jpeg" alt="Cusine">
            <h2>La Cusine</h2>
            <p>Cuisiner est ma schtroumpf passion, schtroumpf expression et schtroumpf communication. Cuisiner permet de laisser les schtroumpfs exprimer leur schtroumpf créativité.</p>
        </figcaption>
    </figure>
    <figure>
        <figcaption>
            <img src="./asset/aviation.jpg" alt="Aviation">
            <h2>L'Aviation</h2>
